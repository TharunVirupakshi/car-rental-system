  ...
  <h2 class="text-4xl font-extrabold dark:text-white p-10 text-center">Payment</h2>
    <div className='flex w-screen justify-center items-center p-10 gap-16'>
      ...
      <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <a  onClick={handlePayment} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          Pay
